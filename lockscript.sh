...
i3lock-color -i /home/john/hm-dotfiles/rosette_nebula.jpg --date-str="%A, %B %d, %Y" --time-str="%H:%M:%S" --clock --time-size=48 --date-size=22 --greeter-align=-20 --date-color=ffffff --time-color=ffffff -e --insidever-color=ebdbb2ff     --ringver-color=fe8019ff --inside-color=076678ff --ring-color=458588ff --line-color=076678ff --keyhl-color=fb4934ff --bshl-color=d3869bff -e --no-verify --nofork --composite
